...
//            MemoryPool &pool = *global_variables::global_memory_pool;
            ASSERT_EQ(correct, uint_to_dec_string(number, 3));
            ASSERT_EQ(correct, uint_to_dec_string(number, 1));
            ASSERT_EQ(correct, uint_to_dec_string(number, 0));
            ASSERT_EQ(correct, uint_to_dec_string(nullptr, 0));
