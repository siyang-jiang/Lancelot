    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        Enables access to private members of cahel::Modulus for C
        */
        ...
        [[nodiscard]] static constexpr int MaxBitCount(
            ...
            switch (sec_level) {
                case sec_level_type::tc128:
                    return util::cahel_he_std_parms_128_tc(poly_modulus_degree);

                case sec_level_type::tc192:
                    return util::cahel_he_std_parms_192_tc(poly_modulus_degree);

                case sec_level_type::tc256:
                    return util::cahel_he_std_parms_256_tc(poly_modulus_degree);
