...
namespace cahel
{
    namespace util
    {
        ...
        */
        ...
        [[nodiscard]] constexpr int cahel_he_std_parms_128_tc(std::size_t poly_modulus_degree) noexcept
        {
        ...
        [[nodiscard]] constexpr int cahel_he_std_parms_192_tc(std::size_t poly_modulus_degree) noexcept
        {
            switch (poly_modulus_degree)
            {
                case std::size_t(1024):
        ...
        [[nodiscard]] constexpr int cahel_he_std_parms_256_tc(std::size_t poly_modulus_degree) noexcept
        {
            switch (poly_modulus_degree)
            {
                case std::size_t(1024):
        ...
        [[nodiscard]] constexpr int cahel_he_std_parms_128_tq(std::size_t poly_modulus_degree) noexcept
        {
            switch (poly_modulus_degree)
            {
                case std::size_t(1024):
        ...
        [[nodiscard]] constexpr int cahel_he_std_parms_192_tq(std::size_t poly_modulus_degree) noexcept
        {
            switch (poly_modulus_degree)
            {
                case std::size_t(1024):
        ...
        [[nodiscard]] constexpr int cahel_he_std_parms_256_tq(std::size_t poly_modulus_degree) noexcept
        {
            switch (poly_modulus_degree)
            {
                case std::size_t(1024):
        ...
        constexpr float distributionParameter = 3.2;
