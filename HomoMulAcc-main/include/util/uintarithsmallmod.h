...
namespace cahel {
    namespace util {
        ...
        */
        [[nodiscard]] inline std::uint64_t div2_uint_mod(std::uint64_t operand, const Modulus &modulus) {
            if (operand & 1) {
                uint64_t temp;
        ...
        */
        [[nodiscard]] inline std::uint64_t add_uint_mod(
            ...
            operand1 += operand2;
            return CAHEL_COND_SELECT(operand1 >= modulus.value(), operand1 - modulus.value(), operand1);
        }
        ...
        */
        [[nodiscard]] inline std::uint64_t sub_uint_mod(
                std::uint64_t operand1, std::uint64_t operand2, const Modulus &modulus) {
            uint64_t temp;
            int64_t borrow = (int64_t) (CAHEL_SUB_BORROW_UINT64(operand1, operand2, 0, &temp));
...
//            uint64_t tmp1, tmp2[2], tmp3, carry;
            ...
            return CAHEL_COND_SELECT(tmp3 >= modulus.value(), tmp3 - modulus.value(), tmp3);
        }
        ...
        */
        ...
        [[nodiscard]] inline std::uint64_t barrett_reduce_64(T input, const Modulus &modulus) {
            ...
            // One more subtraction is enough
            return CAHEL_COND_SELECT(tmp[0] >= modulus.value(), tmp[0] - modulus.value(), tmp[0]);
        }
        ...
        */
        [[nodiscard]] inline std::uint64_t multiply_uint_mod(
            ...
            return CAHEL_COND_SELECT(tmp2 >= p, tmp2 - p, tmp2);
        }
        ...
        */
        inline std::uint64_t multiply_add_uint_mod(
                std::uint64_t operand1, MultiplyUIntModOperand operand2, std::uint64_t operand3,
