...
namespace cahel
{
    namespace util
    {
        ...
        [[nodiscard]] inline unsigned char sub_uint64(
            T operand1, S operand2, unsigned char borrow, uint64_t *result)
        {
            return CAHEL_SUB_BORROW_UINT64(operand1, operand2, borrow, result);
        }
        ...
        {
            CAHEL_MULTIPLY_UINT64_HW64(operand1, operand2, hw64);
        }
        ...
        {
            CAHEL_DIVIDE_UINT128_UINT64(numerator, denominator, quotient);
        }
