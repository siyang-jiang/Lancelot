 ...
 * @param[in] size_QP The key modulus size (key_index)
 */
 ...
 * @brief { {q_mot_t * m + plain_upper_half_threshold } / t + m * coeff_div_plain_modulus} % coeff
 * @param[out] cipher_data
 * @param[in] plain_data
 * @param[in] coeff_modulus_mod_plain_modulus
 * @param[in] plain_upper_half_threshold
 * @param[in] plain_modulus
 * @param[in] coeff_div_plain_modulus
 * @param[in] coeff_modulus
 * @param[in] poly_degree
 * @param[in] coeff_mod_size
 */
__global__ void multiply_add_plain_with_scaling_variant_kernel(uint64_t *cipher_data,
                                                               const uint64_t *plain_data,
                                                               uint64_t coeff_modulus_mod_plain_modulus,
