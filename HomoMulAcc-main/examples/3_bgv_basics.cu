...
void example_bgv_enc(EncryptionParameters &parms, CAHELGPUContext &context) {
...
void example_bgv_add(EncryptionParameters &parms, CAHELGPUContext &context) {
    ...
    */
    ...
    CAHELGPUCiphertext x_cipher(context), y_cipher(context);
    ...
    CAHELGPUPlaintext x_plus_y_plain(context);
    cout << "Decrypting ......" << endl;
    ...
    CAHELGPUPlaintext x_minus_y_plain(context);
    cout << "Decrypting ......" << endl;
...
void example_bgv_add_plain(EncryptionParameters &parms, CAHELGPUContext &context) {
...
void example_bgv_mul(EncryptionParameters &parms, CAHELGPUContext &context) {
    ...
    */
    ...
    CAHELGPUPlaintext xx_plain(context);

    batch_encoder.encode(context, input1, x_plain);
    public_key.encrypt_asymmetric(context, x_plain, x_cipher, false);

    cout << "Compute and relinearize x^2." << endl;
    square_inplace(context, x_cipher);
