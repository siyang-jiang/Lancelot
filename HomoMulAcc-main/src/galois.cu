...
[[nodiscard]] std::uint32_t CAHELGPUGaloisTool::get_elt_from_step(int step) const {
...
[[nodiscard]] std::vector<uint32_t> CAHELGPUGaloisTool::get_elts_all() const {
    ...
    cahel::util::try_invert_uint_mod(generator_, m, neg_power);
...
void CAHELGPUGaloisTool::apply_galois(uint64_t *operand, const DNTTTable &rns_table, size_t coeff_mod_size,
...
void CAHELGPUGaloisTool::apply_galois(uint64_t *operand, const DModulus *rns_modulus, size_t coeff_mod_size,
                                      size_t galois_elt_idx, uint64_t *result) {
    auto &index_raws = index_raw_tables_[galois_elt_idx];
...
void CAHELGPUGaloisTool::apply_galois_ntt(uint64_t *operand, size_t coeff_mod_size, size_t galois_elt_idx,
                                          uint64_t *result) {
