...
typedef struct CAHELGPUBatchEncoder {
    std::size_t slots_;

    cahel::util::Pointer<uint64_t> matrix_reps_index_map_;
    ...
    @param[in] parms The CAHELGPUContext
    ...
    */
    explicit CAHELGPUBatchEncoder(const CAHELGPUContext &context);
    ...
    */
    void
    encode(const CAHELGPUContext &context, const std::vector<int64_t> &values_matrix, CAHELGPUPlaintext &destination);
    ...
    */
    void decode(const CAHELGPUContext &context, const CAHELGPUPlaintext &plain,
