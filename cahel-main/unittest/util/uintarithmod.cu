...
namespace CAHELtest
{
    namespace util
    {
        ...
        {
            vector<std::uint64_t> value(2);
            vector<std::uint64_t> modulus(2);
            value[0] = 0;
            value[1] = 0;
            modulus[0] = 3;
            modulus[1] = 0;
            increment_uint_mod(value.data(), modulus.data(), 2, value.data());
        ...
        TEST(UIntArithMod, DecrementUIntMod)
        {
            ...
            modulus[0] = 3;
            modulus[1] = 0;
            decrement_uint_mod(value.data(), modulus.data(), 2, value.data());
            ASSERT_EQ(1ULL, value[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), value[1]);
            decrement_uint_mod(value.data(), modulus.data(), 2, value.data());
            ASSERT_EQ(static_cast<uint64_t>(0), value[0]);
        ...
        TEST(UIntArithMod, NegateUIntMod)
        {
            ...
            modulus[0] = 3;
            modulus[1] = 0;
            negate_uint_mod(value.data(), modulus.data(), 2, value.data());
            ASSERT_EQ(static_cast<uint64_t>(0), value[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), value[1]);
        ...
        TEST(UIntArithMod, Div2UIntMod)
        {
            ...
            modulus[0] = 3;
            modulus[1] = 0;
            div2_uint_mod(value.data(), modulus.data(), 2, value.data());
        ...
        {
            vector<std::uint64_t> value1(2);
            vector<std::uint64_t> value2(2);
            vector<std::uint64_t> modulus(2);
            value1[0] = 0;
            value1[1] = 0;
            value2[0] = 0;
            ...
            modulus[0] = 3;
            modulus[1] = 0;
            add_uint_uint_mod(value1.data(), value2.data(), modulus.data(), 2, value1.data());
        ...
        TEST(UIntArithMod, SubUIntMod)
        {
            ...
            modulus[0] = 3;
            modulus[1] = 0;
            sub_uint_uint_mod(value1.data(), value2.data(), modulus.data(), 2, value1.data());
            ASSERT_EQ(static_cast<uint64_t>(0), value1[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), value1[1]);
        ...
        TEST(UIntArithMod, TryInvertUIntMod)
        {
            ...
            modulus[0] = 5;
            modulus[1] = 0;
            ASSERT_FALSE(try_invert_uint_mod(value.data(), modulus.data(), 2, value.data()));

            value[0] = 1;
            value[1] = 0;
            modulus[0] = 5;
            modulus[1] = 0;
            ASSERT_TRUE(try_invert_uint_mod(value.data(), modulus.data(), 2, value.data()));
            ASSERT_EQ(1ULL, value[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), value[1]);
