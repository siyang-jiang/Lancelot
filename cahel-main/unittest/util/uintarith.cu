...
//#if CAHEL_COMPILER == CAHEL_COMPILER_MSVC
//#pragma optimize("", on)
//#elif CAHEL_COMPILER == CAHEL_COMPILER_GCC
//#pragma GCC pop_options
//#elif CAHEL_COMPILER == CAHEL_COMPILER_CLANG
...
//#endif
        ...
        TEST(UIntArith, AddUInt128)
        {
            ...
            auto assert_uint128_eq = [](uint64_t *test, uint64_t expect0,
                                        uint64_t expect1) {
                ASSERT_EQ(expect0, test[0]);
                ASSERT_EQ(expect1, test[1]);
            };
            vector<uint64_t> operand1(2, 0);
            vector<uint64_t> operand2(2, 0);
            vector<uint64_t> result(2, 0xFFFFFFFFFFFFFFFFULL);
            ASSERT_FALSE(add_uint128(operand1.data(), operand2.data(), result.data()));
            add_uint128(operand1.data(), operand2.data(), result.data());
            ASSERT_EQ(0, result[0] | result[1]);

            set_uint128(operand1.data(), 1, 1);
            set_uint128(operand2.data(), 1, 1);
            ASSERT_FALSE(add_uint128(operand1.data(), operand2.data(), result.data()));
            assert_uint128_eq(result.data(), 2, 2);

            set_uint128(operand1.data(), 0xFFFFFFFFFFFFFFFFULL, 0);
            set_uint128(operand2.data(), 1, 0);
            ASSERT_FALSE(add_uint128(operand1.data(), operand2.data(), result.data()));
            assert_uint128_eq(result.data(), 0, 1);

            set_uint128(operand1.data(), 0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL);
            set_uint128(operand2.data(), 1, 0);
            ASSERT_TRUE(add_uint128(operand1.data(), operand2.data(), result.data()));
            assert_uint128_eq(result.data(), 0, 0);
        }
        ...
        TEST(UIntArith, AddUInt)
        {
            ...
            ASSERT_FALSE(add_uint(ptr.data(), ptr2.data(), 2, ptr3.data()) != 0);
            ...
            ptr3[0] = 0xFFFFFFFFFFFFFFFF;
            ptr3[1] = 0xFFFFFFFFFFFFFFFF;
            ASSERT_TRUE(add_uint(ptr.data(), ptr2.data(), 2, ptr3.data()) != 0);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[1]);
            ...
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr3[1]);
            ASSERT_TRUE(add_uint(ptr.data(), ptr2.data(), 2, ptr.data()) != 0);
            ...
            ptr3[0] = 0;
            ptr3[1] = 0;
            ASSERT_FALSE(add_uint(ptr.data(), 2, ptr2.data(), 1, false, 2, ptr3.data()) != 0);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(6), ptr3[1]);
            ASSERT_FALSE(add_uint(ptr.data(), 2, ptr2.data(), 1, true, 2, ptr3.data()) != 0);
        ...
        TEST(UIntArith, SubUInt)
        {
            ...
            ptr3[0] = 0xFFFFFFFFFFFFFFFF;
            ptr3[1] = 0xFFFFFFFFFFFFFFFF;
            ASSERT_FALSE(sub_uint(ptr.data(), ptr2.data(), 2, ptr3.data()) != 0);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[1]);
            ...
            ptr3[0] = 0;
            ptr3[1] = 0;
            ASSERT_TRUE(sub_uint(ptr.data(), ptr2.data(), 2, ptr3.data()) != 0);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr3[1]);
            ASSERT_TRUE(sub_uint(ptr.data(), ptr2.data(), 2, ptr.data()) != 0);
            ...
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[1]);
            ASSERT_FALSE(sub_uint(ptr.data(), ptr2.data(), 2, ptr.data()) != 0);
            ...
            ptr3[0] = 0;
            ptr3[1] = 0;
            ASSERT_FALSE(sub_uint(ptr.data(), 2, ptr2.data(), 1, false, 2, ptr3.data()) != 0);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[1]);
            ASSERT_FALSE(sub_uint(ptr.data(), 2, ptr2.data(), 1, true, 2, ptr3.data()) != 0);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFE), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[1]);
        }
        ...
        TEST(UIntArith, SubUIntUInt64)
        {
            ...
            ptr[0] = 0ULL;
            ptr[1] = 0ULL;
            ASSERT_FALSE(sub_uint(ptr.data(), 2, 0ULL, ptr2.data()));
            ASSERT_EQ(0ULL, ptr2[0]);
            ASSERT_EQ(0ULL, ptr2[1]);

            ptr[0] = 0ULL;
            ptr[1] = 0ULL;
            ASSERT_TRUE(sub_uint(ptr.data(), 2, 1ULL, ptr2.data()));
            ASSERT_EQ(0xFFFFFFFFFFFFFFFFULL, ptr2[0]);
            ASSERT_EQ(0xFFFFFFFFFFFFFFFFULL, ptr2[1]);

            ptr[0] = 1ULL;
            ptr[1] = 0ULL;
            ASSERT_TRUE(sub_uint(ptr.data(), 2, 2ULL, ptr2.data()));
            ASSERT_EQ(0xFFFFFFFFFFFFFFFFULL, ptr2[0]);
            ASSERT_EQ(0xFFFFFFFFFFFFFFFFULL, ptr2[1]);

            ptr[0] = 0xFFFFFFFF00000000ULL;
            ptr[1] = 0ULL;
            ASSERT_FALSE(sub_uint(ptr.data(), 2, 0xFFFFFFFFULL, ptr2.data()));
            ASSERT_EQ(0xFFFFFFFE00000001ULL, ptr2[0]);
            ASSERT_EQ(0ULL, ptr2[1]);

            ptr[0] = 0xFFFFFFFF00000000ULL;
            ptr[1] = 0xFFFFFFFF00000000ULL;
            ASSERT_FALSE(sub_uint(ptr.data(), 2, 0x100000000ULL, ptr2.data()));
            ASSERT_EQ(0xFFFFFFFE00000000ULL, ptr2[0]);
            ASSERT_EQ(0xFFFFFFFF00000000ULL, ptr2[1]);

            ptr[0] = 0xFFFFFFFFFFFFFFFFULL;
            ptr[1] = 0xFFFFFFFFFFFFFFFFULL;
            ASSERT_FALSE(sub_uint(ptr.data(), 2, 1ULL, ptr2.data()));
        ...
        TEST(UIntArith, IncrementUInt)
        {
            ...
            ptr1[0] = 0;
            ptr1[1] = 0;
            ASSERT_FALSE(increment_uint(ptr1.data(), 2, ptr2.data()) != 0);
            ASSERT_EQ(1ULL, ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            ASSERT_FALSE(increment_uint(ptr2.data(), 2, ptr1.data()) != 0);
            ...
            ASSERT_TRUE(increment_uint(ptr2.data(), 2, ptr1.data()) != 0);
        ...
        TEST(UIntArith, DecrementUInt)
        {
            ...
            ptr1[0] = 2;
            ptr1[1] = 2;
            ASSERT_FALSE(decrement_uint(ptr1.data(), 2, ptr2.data()) != 0);
            ASSERT_EQ(1ULL, ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(2), ptr2[1]);
            ASSERT_FALSE(decrement_uint(ptr2.data(), 2, ptr1.data()) != 0);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr1[0]);
            ASSERT_EQ(static_cast<uint64_t>(2), ptr1[1]);
            ASSERT_FALSE(decrement_uint(ptr1.data(), 2, ptr2.data()) != 0);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr2[0]);
            ...
            ASSERT_EQ(static_cast<uint64_t>(0), ptr1[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr1[1]);
            ASSERT_TRUE(decrement_uint(ptr1.data(), 2, ptr2.data()) != 0);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr2[1]);
            ASSERT_FALSE(decrement_uint(ptr2.data(), 2, ptr1.data()) != 0);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFE), ptr1[0]);
        ...
        TEST(UIntArith, NegateUInt)
        {
            ...
            ptr[0] = 0;
            ptr[1] = 0;
            negate_uint(ptr.data(), 2, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[1]);
        ...
        TEST(UIntArith, LeftShiftUInt)
        {
            ...
            ptr2[0] = 0xFFFFFFFFFFFFFFFF;
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            left_shift_uint(ptr.data(), 0, 2, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            ptr2[0] = 0xFFFFFFFFFFFFFFFF;
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            left_shift_uint(ptr.data(), 10, 2, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            left_shift_uint(ptr.data(), 10, 2, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[1]);
        ...
        TEST(UIntArith, LeftShiftUInt128)
        {
            ...
            ptr2[0] = 0xFFFFFFFFFFFFFFFF;
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            left_shift_uint128(ptr.data(), 0, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            ptr2[0] = 0xFFFFFFFFFFFFFFFF;
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            left_shift_uint128(ptr.data(), 10, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            left_shift_uint128(ptr.data(), 10, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[1]);
            ...
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555555), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAAA), ptr2[1]);
            left_shift_uint128(ptr.data(), 0, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555555), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAAA), ptr[1]);
            left_shift_uint128(ptr.data(), 1, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAAA), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555554), ptr2[1]);
            left_shift_uint128(ptr.data(), 2, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555554), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAA9), ptr2[1]);
            left_shift_uint128(ptr.data(), 64, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555555), ptr2[1]);
            left_shift_uint128(ptr.data(), 65, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAAA), ptr2[1]);
            left_shift_uint128(ptr.data(), 127, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0x8000000000000000), ptr2[1]);

            left_shift_uint128(ptr.data(), 2, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555554), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAA9), ptr[1]);
            left_shift_uint128(ptr.data(), 64, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555554), ptr[1]);
        }
        ...
        TEST(UIntArith, LeftShiftUInt192)
        {
            ...
            left_shift_uint192(ptr.data(), 0, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            ...
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            ptr2[2] = 0xFFFFFFFFFFFFFFFF;
            left_shift_uint192(ptr.data(), 10, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[2]);
            left_shift_uint192(ptr.data(), 10, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[1]);
        ...
        TEST(UIntArith, RightShiftUInt)
        {
            ...
            ptr2[0] = 0xFFFFFFFFFFFFFFFF;
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            right_shift_uint(ptr.data(), 0, 2, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            ptr2[0] = 0xFFFFFFFFFFFFFFFF;
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            right_shift_uint(ptr.data(), 10, 2, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            right_shift_uint(ptr.data(), 10, 2, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[1]);
            ...
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555555), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAAA), ptr2[1]);
            right_shift_uint(ptr.data(), 0, 2, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555555), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAAA), ptr[1]);
            right_shift_uint(ptr.data(), 1, 2, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0x2AAAAAAAAAAAAAAA), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555555), ptr2[1]);
            right_shift_uint(ptr.data(), 2, 2, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0x9555555555555555), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0x2AAAAAAAAAAAAAAA), ptr2[1]);
            right_shift_uint(ptr.data(), 64, 2, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAAA), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            right_shift_uint(ptr.data(), 65, 2, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555555), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            right_shift_uint(ptr.data(), 127, 2, ptr2.data());
            ASSERT_EQ(1ULL, ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);

            right_shift_uint(ptr.data(), 2, 2, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0x9555555555555555), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0x2AAAAAAAAAAAAAAA), ptr[1]);
            right_shift_uint(ptr.data(), 64, 2, ptr.data());
        ...
        TEST(UIntArith, RightShiftUInt128)
        {
            ...
            ptr2[0] = 0xFFFFFFFFFFFFFFFF;
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            right_shift_uint128(ptr.data(), 0, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            ptr2[0] = 0xFFFFFFFFFFFFFFFF;
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            right_shift_uint128(ptr.data(), 10, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            right_shift_uint128(ptr.data(), 10, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[1]);
            ...
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555555), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAAA), ptr2[1]);
            right_shift_uint128(ptr.data(), 0, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555555), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAAA), ptr[1]);
            right_shift_uint128(ptr.data(), 1, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0x2AAAAAAAAAAAAAAA), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555555), ptr2[1]);
            right_shift_uint128(ptr.data(), 2, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0x9555555555555555), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0x2AAAAAAAAAAAAAAA), ptr2[1]);
            right_shift_uint128(ptr.data(), 64, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0xAAAAAAAAAAAAAAAA), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            right_shift_uint128(ptr.data(), 65, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0x5555555555555555), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            right_shift_uint128(ptr.data(), 127, ptr2.data());
            ASSERT_EQ(1ULL, ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);

            right_shift_uint128(ptr.data(), 2, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0x9555555555555555), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0x2AAAAAAAAAAAAAAA), ptr[1]);
            right_shift_uint128(ptr.data(), 64, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0x2AAAAAAAAAAAAAAA), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[1]);
        }
        ...
        TEST(UIntArith, RightShiftUInt192)
        {
            ...
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            ptr2[2] = 0xFFFFFFFFFFFFFFFF;
            right_shift_uint192(ptr.data(), 0, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[2]);
            ptr2[0] = 0xFFFFFFFFFFFFFFFF;
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            ptr2[2] = 0xFFFFFFFFFFFFFFFF;
            right_shift_uint192(ptr.data(), 10, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[2]);
            right_shift_uint192(ptr.data(), 10, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[1]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[2]);
        ...
        TEST(UIntArith, HalfRoundUpUInt)
        {
            ...
            ptr2[0] = 0xFFFFFFFFFFFFFFFF;
            ptr2[1] = 0xFFFFFFFFFFFFFFFF;
            half_round_up_uint(ptr.data(), 2, ptr2.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr2[1]);
            half_round_up_uint(ptr.data(), 2, ptr.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[1]);
        ...
        TEST(UIntArith, AndUInt)
        {
            ...
            ptr3[0] = 0xFFFFFFFFFFFFFFFF;
            ptr3[1] = 0xFFFFFFFFFFFFFFFF;
            and_uint(ptr.data(), ptr2.data(), 2, ptr3.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[1]);
            ...
            and_uint(ptr.data(), ptr2.data(), 2, ptr.data());
        ...
        TEST(UIntArith, OrUInt)
        {
            ...
            ptr3[0] = 0;
            ptr3[1] = 0;
            or_uint(ptr.data(), ptr2.data(), 2, ptr3.data());
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr3[1]);
            ...
            or_uint(ptr.data(), ptr2.data(), 2, ptr.data());
        ...
        TEST(UIntArith, XorUInt)
        {
            ...
            ptr3[0] = 0;
            ptr3[1] = 0;
            xor_uint(ptr.data(), ptr2.data(), 2, ptr3.data());
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr3[1]);
            ...
            xor_uint(ptr.data(), ptr2.data(), 2, ptr.data());
        ...
        {
            uint64_t result;
            multiply_uint64_hw64_generic(uint64_t(0), uint64_t(0), &result);
            ASSERT_EQ(uint64_t(0), result);
        ...
        TEST(UIntArith, MultiplyManyUInt64)
        {
            ...
            multiply_many_uint64(in.data(), 1, out.data());
            ...
            multiply_many_uint64(in.data(), 1, out.data());
            ASSERT_TRUE(expected == out);
            multiply_many_uint64(in.data(), 2, out.data());
            ASSERT_TRUE(expected == out);
            multiply_many_uint64(in.data(), 3, out.data());
            ASSERT_TRUE(expected == out);
        ...
        TEST(UIntArith, MultiplyManyUInt64Except)
        {
            ...
            multiply_many_uint64_except(in.data(), 2, 0, out.data());
            ASSERT_TRUE(expected == out);
            multiply_many_uint64_except(in.data(), 2, 1, out.data());
            ASSERT_TRUE(expected == out);
            multiply_many_uint64_except(in.data(), 3, 0, out.data());
            ASSERT_TRUE(expected == out);
            multiply_many_uint64_except(in.data(), 3, 1, out.data());
            ASSERT_TRUE(expected == out);
            multiply_many_uint64_except(in.data(), 3, 2, out.data());
            ASSERT_TRUE(expected == out);
        ...
        TEST(UIntArith, MultiplyUInt)
        {
            ...
            multiply_uint(ptr.data(), ptr2.data(), 2, ptr3.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[1]);
            ...
            ptr3[2] = 0;
            ptr3[3] = 0;
            multiply_uint(ptr.data(), 2, ptr2.data(), 1, 2, ptr3.data());
            ASSERT_EQ(1ULL, ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr3[1]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[2]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[3]);
            ...
            ptr3[2] = 0;
            ptr3[3] = 0;
            multiply_uint(ptr.data(), 2, ptr2.data(), 1, 3, ptr3.data());
            ASSERT_EQ(1ULL, ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr3[1]);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFE), ptr3[2]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[3]);
            ...
            ptr3[2] = 0;
            ptr3[3] = 0;
            multiply_truncate_uint(ptr.data(), ptr2.data(), 2, ptr3.data());
            ASSERT_EQ(1ULL, ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0xFFFFFFFFFFFFFFFF), ptr3[1]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[2]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[3]);
        ...
        {
            vector<uint64_t>ptr(2);
            vector<uint64_t>result(4);
            ptr[0] = 0;
            ptr[1] = 0;
            ptr[2] = 0;
            multiply_uint(ptr.data(), 3, 0ULL, 4, result.data());
            ASSERT_EQ(0ULL, result[0]);
            ASSERT_EQ(0ULL, result[1]);
            ...
            ptr[1] = 0xAAAAAAAAA;
            ptr[2] = 0x111111111;
            multiply_uint(ptr.data(), 3, 1ULL, 4, result.data());
            ...
            ptr[1] = 0xAAAAAAAAA;
            ptr[2] = 0x111111111;
            multiply_uint(ptr.data(), 3, 0x10000ULL, 4, result.data());
            ...
            ptr[1] = 0xAAAAAAAAA;
            ptr[2] = 0x111111111;
            multiply_uint(ptr.data(), 3, 0x100000000ULL, 4, result.data());
            ...
            multiply_uint(ptr.data(), 3, 7878787878787878ULL, 4, result.data());
        ...
        {
            vector<uint64_t>ptr(4);
            vector<uint64_t>ptr2(4);
            vector<uint64_t>ptr3(4);
            vector<uint64_t>ptr4(4);
            divide_uint_inplace(nullptr, nullptr, 0, nullptr);
            divide_uint(nullptr, nullptr, 0, nullptr, nullptr);
            ...
            ptr3[0] = 0xFFFFFFFFFFFFFFFF;
            ptr3[1] = 0xFFFFFFFFFFFFFFFF;
            divide_uint_inplace(ptr.data(), ptr2.data(), 2, ptr3.data());
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[1]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr3[1]);
            ...
            divide_uint(ptr.data(), ptr2.data(), 4, ptr3.data(), ptr4.data());
            ...
            divide_uint_inplace(ptr.data(), ptr2.data(), 4, ptr3.data());
            ASSERT_EQ(static_cast<uint64_t>(2), ptr[0]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[1]);
            ASSERT_EQ(static_cast<uint64_t>(0), ptr[2]);
