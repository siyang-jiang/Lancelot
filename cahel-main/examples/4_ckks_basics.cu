...
void example_ckks_enc(EncryptionParameters &parms, CAHELGPUContext &context, const double &scale) {
    ...
    CAHELGPUCiphertext x_asymmetric_cipher(context);
    public_key.encrypt_asymmetric(context, x_plain, x_asymmetric_cipher, false);
    CAHELGPUPlaintext x_asymmetric_plain(context);
...
void example_ckks_add(EncryptionParameters &parms, CAHELGPUContext &context, const double &scale) {
    ...
    CAHELGPUPlaintext x_plain(context), y_plain(context);
    print_line(__LINE__);
    cout << "Encode input vectors." << endl;
    encoder.encode(context, input1, scale, x_plain);
    encoder.encode(context, input2, scale, y_plain);

    CAHELGPUCiphertext x_sym_cipher(context), y_sym_cipher(context);
    ...
    CAHELGPUPlaintext x_plus_y_sym_plain(context);
    cout << "Decrypting ......" << endl;
    ...
    CAHELGPUPlaintext x_minus_y_sym_plain(context);
    cout << "Decrypting ......" << endl;
    ...
    CAHELGPUCiphertext x_asym_cipher(context), y_asym_cipher(context);
    ...
    CAHELGPUPlaintext x_plus_y_asym_plain(context);
    cout << "Decrypting ......" << endl;
    ...
    CAHELGPUPlaintext x_minus_y_asym_plain(context);
    cout << "Decrypting ......" << endl;
    ...
    vector<CAHELGPUCiphertext> ciphers;
    ...
    CAHELGPUCiphertext sum_cipher(context);
    add_many(context, ciphers, sum_cipher);

    CAHELGPUPlaintext sum_plain(context);
    cout << "Decrypting ......" << endl;
 ...
 */
void example_ckks_mul_plain(EncryptionParameters &parms, CAHELGPUContext &context, const double &scale) {
    ...
    CAHELGPUPlaintext plain(context), const_plain(context);
...
void example_ckks_mul(EncryptionParameters &parms, CAHELGPUContext &context, const double &scale) {
    ...
    CAHELGPUPlaintext x_plain(context);
    CAHELGPUPlaintext y_plain(context);
    CAHELGPUPlaintext xy_plain(context);

    encoder.encode(context, x_msg, scale, x_plain);
    encoder.encode(context, y_msg, scale, y_plain);

    CAHELGPUCiphertext x_cipher(context);
    CAHELGPUCiphertext y_cipher(context);
...
void example_ckks_rotation(EncryptionParameters &parms, CAHELGPUContext &context, const double &scale) {
    ...
    CAHELGPUPublicKey public_key(context);
    secret_key.gen_publickey(context, public_key);
    CAHELGPUGaloisKey galois_keys(context);
    ...
    CAHELGPUPlaintext x_plain(context);
    CAHELGPUPlaintext x_rot_plain(context);
    ...
    CAHELGPUPlaintext x_conj_plain(context);
...
void example_ckks_basics(EncryptionParameters &parms, CAHELGPUContext &context, const double &scale) {
    std::cout << "Example: CKKS Basics" << std::endl;
    ...
    */
    CAHELGPUPlaintext plain_coeff3(context), plain_coeff1(context), plain_coeff0(context);
    ...
    cout << "Encode input vectors." << endl;
    encoder.encode(context, input, scale, x_plain);
    CAHELGPUCiphertext x1_encrypted(context);
    ...
    now grown to 2^80.
    */
    CAHELGPUCiphertext x3_encrypted(context);
    print_line(__LINE__);
    cout << "Compute x^2 and relinearize:" << endl;
    square(context, x1_encrypted, x3_encrypted);
    ...
    */
    ...
    CAHELGPUCiphertext x1_encrypted_coeff3(context);
    ...
    */
    ...
    // CAHELGPUPlaintext plain_result(context);
    // print_line(__LINE__);
    ...
    */
    ...
    to 2^40, we can simply "lie" to ByteDance CAHELGPUFHE and set the scales to be the
    ...
    */
    ...
    CAHELGPUCiphertext encrypted_result(context);
...
void example_ckks_stress_test(EncryptionParameters &parms, CAHELGPUContext &context, const double &scale) {
    CAHELGPUSecretKey secret_key(parms);
    secret_key.gen_secretkey(context);
    CAHELGPUPublicKey public_key(context);
    secret_key.gen_publickey(context, public_key);
    ...
    */
    ...
    for (auto alpha: v_alpha) {
        ...
        */
        ...
        CAHELGPUContext context(parms, true, sec_level_type::none);
